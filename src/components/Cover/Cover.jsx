...
const Cover = ({ children, background, alt = "", hasParallax = false }) => {
    ...
    return (
        <div className="text-white min-h-[600px] relative flex justify-center items-center z-10">
            {!background && !context?.featuredImage && <div className='absolute inset-0 blur-xl bg-gradient-to-t from-primary/0 to-secondary/10 overflow-hidden'>
            ...
            {(background || context?.featuredImage) &&
